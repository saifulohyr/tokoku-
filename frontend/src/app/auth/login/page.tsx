        ...
        <div className="w-full max-w-sm mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Masuk untuk mengakses koleksi eksklusif PULLEX.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="text-xs font-medium text-black dark:text-white hover:underline">
                  Lupa password?
                </Link>
              </div>
              <Input
            ...
            <div className="pt-6">
              ...
              >
                {login.isPending ? (
                  ...
                  <>
                    LOGIN NOW <ArrowRight className="ml-2 w-4 h-4" />
                  </>
                )}
              </Button>
            </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-sm text-muted-foreground">
              Belum punya akun?{" "}
              <Link href="/auth/register" className="text-black dark:text-white font-bold uppercase tracking-wider hover:underline ml-1">
                Daftar sekarang
              </Link>
            </p>
          </div>
        ...
        <div className="absolute bottom-0 left-0 p-12 lg:p-24 text-white z-10 w-full bg-gradient-to-t from-black/90 via-black/40 to-transparent">
           ...
           >
             ...
             <p className="text-zinc-300 max-w-md text-lg font-light leading-relaxed">
               Bergabunglah dengan komunitas PULLEX dan rasakan performa tanpa batas dengan teknologi gear terbaru.
             </p>
           </motion.div>
        </div>
      </div>
